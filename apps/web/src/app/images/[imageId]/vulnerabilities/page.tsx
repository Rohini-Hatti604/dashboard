...
import VulnerabilitiesTabContent from "@/components/sections/browse-images/vulnerabilities-tab-content";

//import ProvenanceTabContent from "@/components/sections/browse-images/provenance-tab-content"
...
export default async function ImageDetailsPage({ params }: Props) {
  ...
  if (!image && imageId !== "prometheus") {
   ...
   return (
            ...
            <VulnerabilitiesTabContent vulnerabilitiesData={image.vulnerabilitiesData || []} />
