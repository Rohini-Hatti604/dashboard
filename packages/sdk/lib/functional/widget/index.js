...
(function (create) {
    ...
    create.path = function () { return "/widget/create"; };
...
(function (list) {
    ...
    list.path = function () { return "/widget/list"; };
...
(function (update) {
    ...
    update.path = function () { return "/widget/update"; };
 ...
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
function aggregate(connection, query) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, PlainFetcher_1.PlainFetcher.fetch(__assign(__assign({}, connection), { headers: __assign(__assign({}, connection.headers), { "Content-Type": "application/json" }) }), __assign(__assign({}, aggregate.METADATA), { template: aggregate.METADATA.path, path: aggregate.path() }), query)];
        });
    });
}
(function (aggregate) {
    ...
    aggregate.path = function () { return "/widget/aggregate"; };
})(aggregate || (exports.aggregate = aggregate = {}));
